...
public class CopyOfArtifactDetailReport extends ReportBase {
	...
	public CopyOfArtifactDetailReport() {
	}
	
	public CopyOfArtifactDetailReport(Hashtable properties) {
		this.properties = properties;
	}
	
	public static void main (String[] args) {
		try {
			CopyOfArtifactDetailReport report = new CopyOfArtifactDetailReport();
			FileSystemUtil.createFile("C:\\ant\\osrmt\\database\\reports","ArtifactDetail.jrxml",
					report.getContent());
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public ReportElementList getHeaderFields() {
		...
		ReportPosition pos = new ReportPosition(styleHeader, 0,20,100,11);
	...
	public ReportElementList getTextFields() {
		...
		ReportPosition pos = new ReportPosition(styleNormal, 0,0,100,11);
