 ...
 */
public class UIComboDocument extends PlainDocument {
    ...
    /**
     * Initialize the combo box with editing
     * 
     * @param comboBox
     */
    public UIComboDocument(final JComboBox comboBox) {
    ...
    public UIComboDocument(JComboBox comboBox, ReferenceListListener listener) {
    	comboBox.addItemListener(listener);
    }
    
    /**
     * Enable editing on the combo box
     * 
     * @param comboBox
     */
    public static void enable(JComboBox comboBox) {
        ...
        new UIComboDocument(comboBox);
    }
    
    /**
     * Configure the combo box editor
     * 
     * @param newEditor
     */
    ...
    /**
     * Selected the item from the list
     * 
     * @param item
     */
