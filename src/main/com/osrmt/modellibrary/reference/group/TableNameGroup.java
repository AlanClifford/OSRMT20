...
public class TableNameGroup implements java.io.Serializable {
	...
	public TableNameGroup(int TableNameRefId) {
	...
	public static TableNameGroup get(int TableNameRefId) {
		return new TableNameGroup(TableNameRefId);
	}
