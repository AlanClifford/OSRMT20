 ...
 * the models depends on the parameters defined in osrmt_schem.mdb ModelLibrary.
*/
public class RequirementTreeDataModel implements IControlModel, java.io.Serializable {
...
public static ResultColumnList getResultColumnList() {
	 ...
	 */ 
	public void copyModifiedTo(RequirementTreeDataModel m) {
		Enumeration e1 = modifiedFields.keys();
		while (e1.hasMoreElements()) {
			String fieldName = (String) e1.nextElement();

			if (fieldName.compareTo("requirementTreeId")==0)
	 ...
	 */
	public boolean isEqualTo (RequirementTreeModel m) {
	...
	public String toString() {
		try {
			...
			sb.append("RequirementTreeModel:\r\n");
	...
	public void setModelColDataAt(Object o, int modelCol) {
			switch (modelCol) {
			case 507: setRequirementTreeId(((Integer) o).intValue()); break;
			case 508: setChildId(((Integer) o).intValue()); break;
			case 509: setChildArtifactRefId(((Integer) o).intValue()); break;
			case 1180: setRelationRefId(((Integer) o).intValue()); break;
			case 510: setParentId(((Integer) o).intValue()); break;
			case 511: setParentArtifactRefId(((Integer) o).intValue()); break;
			case 512: setCreateDt((GregorianCalendar) o); break;
			case 513: setCreateUserId(((Integer) o).intValue()); break;
			case 799: setCreateUserName((String) o); break;
			case 514: setUpdateDt((GregorianCalendar) o); break;
			case 515: setUpdateUserId(((Integer) o).intValue()); break;
			case 800: setUpdateUserName((String) o); break;
			case 516: setUpdateCount(((Integer) o).intValue()); break;
			case 517: setActiveInd(((Integer) o).intValue()); break;
			case 518: setSystemAssignedVersionNbr(((Integer) o).intValue()); break;
			case 519: setRecordTypeRefId(((Integer) o).intValue()); break;
	...
	public Object getModelColDataAt(int modelCol) {
			if (modelCol == 507) return new Integer(requirementTreeId);
			if (modelCol == 508) return new Integer(childId);
			if (modelCol == 509) return new Integer(childArtifactRefId);
			if (modelCol == 509) return childArtifactRefDisplay;
			if (modelCol == 1180) return new Integer(relationRefId);
			if (modelCol == 1180) return relationRefDisplay;
			if (modelCol == 510) return new Integer(parentId);
			if (modelCol == 511) return new Integer(parentArtifactRefId);
			if (modelCol == 511) return parentArtifactRefDisplay;
			if (modelCol == 512) return createDt;
			if (modelCol == 513) return new Integer(createUserId);
			if (modelCol == 513) return createUserName;
			if (modelCol == 514) return updateDt;
			if (modelCol == 515) return new Integer(updateUserId);
			if (modelCol == 515) return updateUserName;
			if (modelCol == 516) return new Integer(updateCount);
			if (modelCol == 517) return new Integer(activeInd);
			if (modelCol == 518) return new Integer(systemAssignedVersionNbr);
			if (modelCol == 519) return new Integer(recordTypeRefId);
			if (modelCol == 519) return recordTypeRefDisplay;
		return null;
	}

	public int getModelColDatabaseDataType(int modelCol) {
			if (modelCol == 507) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 508) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 509) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 509) return DatabaseDataTypeFramework.STRING;
			if (modelCol == 1180) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 1180) return DatabaseDataTypeFramework.STRING;
			if (modelCol == 510) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 511) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 511) return DatabaseDataTypeFramework.STRING;
			if (modelCol == 512) return DatabaseDataTypeFramework.DATE;
			if (modelCol == 513) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 513) return DatabaseDataTypeFramework.STRING;
			if (modelCol == 514) return DatabaseDataTypeFramework.DATE;
			if (modelCol == 515) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 515) return DatabaseDataTypeFramework.STRING;
			if (modelCol == 516) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 517) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 518) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 519) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 519) return DatabaseDataTypeFramework.STRING;
			return DatabaseDataTypeFramework.STRING;
	}

	public boolean isNew() {
		return getRequirementTreeId() == 0;
	}

	public Object getPrimaryValue() {
		return new Integer(getRequirementTreeId());
	}

	public Object getDataAt(int i) {
			if (i == 0) return new Integer(requirementTreeId);
			if (i == 1) return new Integer(childId);
			if (i == 2) return new Integer(childArtifactRefId);
			if (i == 3) return childArtifactRefDisplay;
			if (i == 4) return new Integer(relationRefId);
			if (i == 5) return relationRefDisplay;
			if (i == 6) return new Integer(parentId);
			if (i == 7) return new Integer(parentArtifactRefId);
			if (i == 8) return parentArtifactRefDisplay;
	...
	public void setDataAt(Object o, int i) {
		switch(i) {
			case 0: setRequirementTreeId(((Integer) o).intValue()); break;
			case 1: setChildId(((Integer) o).intValue()); break;
			case 2: setChildArtifactRefId(((Integer) o).intValue()); break;
			case 3: setChildArtifactRefDisplay((String) o); break;
			case 4: setRelationRefId(((Integer) o).intValue()); break;
			case 5: setRelationRefDisplay((String) o); break;
			case 6: setParentId(((Integer) o).intValue()); break;
			case 7: setParentArtifactRefId(((Integer) o).intValue()); break;
			case 8: setParentArtifactRefDisplay((String) o); break;
