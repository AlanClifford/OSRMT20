...
null
*/
public class AppControlTemplateDataModel implements IControlModel, java.io.Serializable {
	...
	private int appControlTemplateId = 0;
	...
	/** Foreign key to Reference - ControlTemplate  */
	 ...
	 * 
	 */ 
	public int getAppControlTemplateId() {
		return appControlTemplateId;
	}
	 ...
	 */ 
	public void setAppControlTemplateId(int appControlTemplateId) {
		if (!Comparison.areEqual(this.appControlTemplateId, appControlTemplateId)) {
			this.appControlTemplateId = appControlTemplateId;
			setModified("appControlTemplateId");
		};
	}
...
public static ResultColumnList getResultColumnList() {
	ResultColumnList columns = new ResultColumnList();
		columns.addColumn("appControlTemplateId", Integer.class);
	 ...
	 */ 
	public void copyModifiedTo(AppControlTemplateDataModel m) {
		Enumeration e1 = modifiedFields.keys();
		while (e1.hasMoreElements()) {
			String fieldName = (String) e1.nextElement();

			if (fieldName.compareTo("appControlTemplateId")==0)
				m.setAppControlTemplateId(this.getAppControlTemplateId());
	 ...
	 */
	public void updateWith (AppControlTemplateModel m) {

		this.setAppControlTemplateId(m.getAppControlTemplateId());
	 ...
	 */
	public boolean isEqualTo (AppControlTemplateModel m) {

		if (!Comparison.areEqual(this.getAppControlTemplateId(),  m.getAppControlTemplateId())) return false;
	...
	public String toString() {
		try {
			...
			sb.append("AppControlTemplateModel:\r\n");
			sb.append("app_control_template_id:" + getAppControlTemplateId());
			sb.append("\r\n");
			...
			return "AppControlTemplateModel:"; 
		}
	}
	public void setModelColDataAt(Object o, int modelCol) {
			switch (modelCol) {
			case 5613: setAppControlTemplateId(((Integer) o).intValue()); break;
			case 5573: setApplicationViewId(((Integer) o).intValue()); break;
			case 5574: setDisplaySequence(((Integer) o).intValue()); break;
			case 5575: setControlRefId(((Integer) o).intValue()); break;
			case 5576: setControlTypeRefId(((Integer) o).intValue()); break;
			case 5577: setControlText((String) o); break;
			case 5578: setControlDescription((String) o); break;
			case 5579: setModelColumnRefId(((Integer) o).intValue()); break;
			case 5580: setApplicationCustomControlId(((Integer) o).intValue()); break;
			case 5581: setAppControlUserDefinedId(((Integer) o).intValue()); break;
			case 5582: setControlFormat((String) o); break;
			case 5583: setSourceRefId(((Integer) o).intValue()); break;
			case 5584: setDefaultValue((String) o); break;
			case 5585: setLockedInd(((Integer) o).intValue()); break;
			case 5586: setDisabledInd(((Integer) o).intValue()); break;
			case 5587: setRequiredInd(((Integer) o).intValue()); break;
			case 5588: setVisibleInd(((Integer) o).intValue()); break;
			case 5589: setInitScript((String) o); break;
			case 5590: setFocusLostScript((String) o); break;
			case 5591: setFocusGainedScript((String) o); break;
			case 5592: setImagePath((String) o); break;
			case 5593: setScrollpaneInd(((Integer) o).intValue()); break;
			case 5594: setGrowHeight(((Double) o).doubleValue()); break;
			case 5595: setGrowWidth(((Integer) o).intValue()); break;
			case 5596: setUnitWidth(((Integer) o).intValue()); break;
			case 5597: setUnitHeight(((Integer) o).intValue()); break;
			case 5598: setCreateDt((GregorianCalendar) o); break;
			case 5599: setCreateUserId(((Integer) o).intValue()); break;
			case 5610: setCreateUserName((String) o); break;
			case 5600: setUpdateDt((GregorianCalendar) o); break;
			case 5601: setUpdateUserId(((Integer) o).intValue()); break;
			case 5611: setUpdateUserName((String) o); break;
			case 5602: setUpdateCount(((Integer) o).intValue()); break;
			case 5603: setActiveInd(((Integer) o).intValue()); break;
			case 5604: setSystemAssignedVersionNbr(((Integer) o).intValue()); break;
			case 5605: setRecordTypeRefId(((Integer) o).intValue()); break;
	...
	public Object getModelColDataAt(int modelCol) {
			if (modelCol == 5613) return new Integer(appControlTemplateId);
			if (modelCol == 5573) return new Integer(applicationViewId);
			if (modelCol == 5574) return new Integer(displaySequence);
			if (modelCol == 5575) return new Integer(controlRefId);
			if (modelCol == 5575) return controlRefDisplay;
			if (modelCol == 5576) return new Integer(controlTypeRefId);
			if (modelCol == 5576) return controlTypeRefDisplay;
			if (modelCol == 5577) return controlText;
			if (modelCol == 5578) return controlDescription;
			if (modelCol == 5579) return new Integer(modelColumnRefId);
			if (modelCol == 5579) return modelColumnRefDisplay;
			if (modelCol == 5580) return new Integer(applicationCustomControlId);
			if (modelCol == 5581) return new Integer(appControlUserDefinedId);
			if (modelCol == 5582) return controlFormat;
			if (modelCol == 5583) return new Integer(sourceRefId);
			if (modelCol == 5583) return sourceRefDisplay;
			if (modelCol == 5584) return defaultValue;
			if (modelCol == 5585) return new Integer(lockedInd);
			if (modelCol == 5586) return new Integer(disabledInd);
			if (modelCol == 5587) return new Integer(requiredInd);
			if (modelCol == 5588) return new Integer(visibleInd);
			if (modelCol == 5589) return initScript;
			if (modelCol == 5590) return focusLostScript;
			if (modelCol == 5591) return focusGainedScript;
			if (modelCol == 5592) return imagePath;
			if (modelCol == 5593) return new Integer(scrollpaneInd);
			if (modelCol == 5594) return new Double(growHeight);
			if (modelCol == 5595) return new Integer(growWidth);
			if (modelCol == 5596) return new Integer(unitWidth);
			if (modelCol == 5597) return new Integer(unitHeight);
			if (modelCol == 5598) return createDt;
			if (modelCol == 5599) return new Integer(createUserId);
			if (modelCol == 5599) return createUserName;
			if (modelCol == 5600) return updateDt;
			if (modelCol == 5601) return new Integer(updateUserId);
			if (modelCol == 5601) return updateUserName;
			if (modelCol == 5602) return new Integer(updateCount);
			if (modelCol == 5603) return new Integer(activeInd);
			if (modelCol == 5604) return new Integer(systemAssignedVersionNbr);
			if (modelCol == 5605) return new Integer(recordTypeRefId);
			if (modelCol == 5605) return recordTypeRefDisplay;
		return null;
	}

	public int getModelColDatabaseDataType(int modelCol) {
			if (modelCol == 5613) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 5573) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 5574) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 5575) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 5575) return DatabaseDataTypeFramework.STRING;
			if (modelCol == 5576) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 5576) return DatabaseDataTypeFramework.STRING;
			if (modelCol == 5577) return DatabaseDataTypeFramework.STRING;
			if (modelCol == 5578) return DatabaseDataTypeFramework.STRING;
			if (modelCol == 5579) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 5579) return DatabaseDataTypeFramework.STRING;
			if (modelCol == 5580) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 5581) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 5582) return DatabaseDataTypeFramework.STRING;
			if (modelCol == 5583) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 5583) return DatabaseDataTypeFramework.STRING;
			if (modelCol == 5584) return DatabaseDataTypeFramework.STRING;
			if (modelCol == 5585) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 5586) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 5587) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 5588) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 5589) return DatabaseDataTypeFramework.STRING;
			if (modelCol == 5590) return DatabaseDataTypeFramework.STRING;
			if (modelCol == 5591) return DatabaseDataTypeFramework.STRING;
			if (modelCol == 5592) return DatabaseDataTypeFramework.STRING;
			if (modelCol == 5593) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 5594) return DatabaseDataTypeFramework.DOUBLE;
			if (modelCol == 5595) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 5596) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 5597) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 5598) return DatabaseDataTypeFramework.DATE;
			if (modelCol == 5599) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 5599) return DatabaseDataTypeFramework.STRING;
			if (modelCol == 5600) return DatabaseDataTypeFramework.DATE;
			if (modelCol == 5601) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 5601) return DatabaseDataTypeFramework.STRING;
			if (modelCol == 5602) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 5603) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 5604) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 5605) return DatabaseDataTypeFramework.INTEGER;
			if (modelCol == 5605) return DatabaseDataTypeFramework.STRING;
			return DatabaseDataTypeFramework.STRING;
	}

	public boolean isNew() {
		return getAppControlTemplateId() == 0;
	}

	public Object getPrimaryValue() {
		return new Integer(getAppControlTemplateId());
	}

	public Object getDataAt(int i) {
			if (i == 0) return new Integer(appControlTemplateId);
	...
	public void setDataAt(Object o, int i) {
		switch(i) {
			case 0: setAppControlTemplateId(((Integer) o).intValue()); break;
