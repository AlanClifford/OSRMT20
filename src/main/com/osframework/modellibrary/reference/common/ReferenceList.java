 ...
 * the models depends on the parameters defined in osrmt_schem.mdb ModelLibrary.
*/
public class ReferenceList extends ResultList implements  Enumeration, java.io.Serializable {

	private static final long serialVersionUID = 1L;
	private Vector list = new Vector();
	private ResultColumnList columns = ReferenceModel.getResultColumnList();
	...
	public void add(ReferenceModel m) {
		this.list.add(m);
		
	}
	public void addAll(ReferenceList list) {
	...
	public ReferenceModel elementAt(int rowIndex) {
			return (ReferenceModel) list.get(rowIndex);
	}

	public void remove(ReferenceModel m) {
			list.remove(m);
	}

	public Object getValueAt(int rowIndex, int columnIndex) {
		try {
			ReferenceModel m = (ReferenceModel) list.get(rowIndex);
	...
	public ReferenceModel getFirst() {
		if (list.size() > 0) {
			return (ReferenceModel) list.elementAt(0);
		} else {
